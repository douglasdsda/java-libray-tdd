...
public interface LoanRepository extends JpaRepository<Loan, Long> {
    ...
    @Query(" select l from Loan l where l.loanDate <= :threDaysAgo and ( l.returned is null or returned is false)")
    List<Loan> findByLoanDateLessThanNotReturned(@Param("threDaysAgo") LocalDate threDaysAgo);
}
